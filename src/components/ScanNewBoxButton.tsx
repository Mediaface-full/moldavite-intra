  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={handleScan}
        disabled={scanning}
        className="bg-primary hover:bg-primary/90 disabled:opacity-50 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
      >
        ...
        {scanning ? 'Skenuji...' : 'Načíst nové kazety'}
      </button>
    </div>
  );
}
