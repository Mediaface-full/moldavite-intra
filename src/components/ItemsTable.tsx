                  ...
                  {(() => {
                    ...
                    if (status === 'STALE') {
                      return (
                        <Link
                          ...
                          className="inline-flex items-center justify-center w-6 h-6 rounded-md hover:opacity-80 transition-opacity"
                          style={{
                    ...
                    return (
                      <Link
                        href={`/items/${item.id}`}
                        title={tooltip}
                        className="inline-flex items-center justify-center w-6 h-6 rounded-md cursor-help hover:opacity-90 transition-opacity"
                        style={{
