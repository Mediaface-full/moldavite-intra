...
const CSRF_ENFORCED_PREFIXES = ['/api/admin/', '/api/items', '/api/boxes', '/api/ai/', '/api/scan', '/api/rates', '/api/orders', '/api/pricing-config', '/api/attr-options', '/api/sellers', '/api/vseved/'];
